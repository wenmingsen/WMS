...
public class DrtShopOrderDetailController{
	...
	@ResponseBody
	public Map<String,Object> insertOrder(String id,String itemNum,String orderNum,String addressId,String name,String phone,String address,HttpServletRequest request){
		...
		Map<String,Object> objMap = drtShopOrderDetailService.insertOrder(id,itemNum1, orderNum, name,addressId, phone, address, accountId);
		return objMap;
	 ...
	 * @return 结果
	 */
	@RequestMapping(value = "/changeNumEarnings",method = RequestMethod.POST)
	@ResponseBody

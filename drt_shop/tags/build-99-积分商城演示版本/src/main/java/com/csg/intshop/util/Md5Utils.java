...
public class Md5Utils {
	...
	public static String encodeMd5ToLowerCase16(String source){
		return encodeMd5ToLowerCase(source).substring(8, 24);
	}
	
	public static String encodeMd5ToLowerCase(String source){
		return encodeMd5(source).toLowerCase();
	}
	...
	// 将字节转换为十六进制字符串
		...
		*/ 
		...
		public static void main(String[] args) {
			System.out.println(encodeMd5ToLowerCase16("hello123"));

...
public interface EarningsCore {
	...
	public Map<String, Object> updateEarningsFromExchange(@RequestParam(value="accountId") String accountId, @RequestParam(value="earnings") Integer earnings, @RequestParam(value="plusminus") String plusminus);
}

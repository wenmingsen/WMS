...
public class DrtShopAddress{
	...
	/**
	 * 一级地址Id
	 * @param addressLevel1Id 设置 addressLevel1Id 属性值为参数值 addressLevel1Id
	 */
	public void setAddressLevel1Id(String addressLevel1Id) {
		this.addressLevel1Id = addressLevel1Id == null ? null : addressLevel1Id.trim();
	}
	/**
	 * 一级地址Id
     * @return 获取addressLevel1Id属性值
     */
	...
	/**
	 * 二级地址Id
	 * @param addressLevel2Id 设置 addressLevel2Id 属性值为参数值 addressLevel2Id
	 */
	public void setAddressLevel2Id(String addressLevel2Id) {
		this.addressLevel2Id = addressLevel2Id == null ? null : addressLevel2Id.trim();
	}
	/**
	 * 二级地址Id
     * @return 获取addressLevel2Id属性值
     */
	...
	public void setAddressLevel3Id(String addressLevel3Id) {

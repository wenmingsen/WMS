...
public class SystemConstants {
    ...
    //被第三方设备登陆
    public static final String LOGIN_SQUEEZE="-3";
    ...
    // 响应状态码，-1：失败(重复登陆)
 	...
 	//异常状态码 404 路径错误
 	public static final Integer ERROR_STATUS_404=404;
 	

 	//异常状态码 500 程序异常
 	public static final String ERROR_STATUS_500="500";
...
*/    
    ...
    //订单状态
    public static final Integer ORDERSTATE = 1;//代兑换
    
    //同步订单状态异常信息
    public static final String ERROR_MSG_ORDERCODE_NULL = "积分商城订单编号为空！";//积分商城订单编号为空
    public static final String ERROR_MSG_ORDERSTATUS_NULL = "积分商城订单状态为空！";//积分商城订单状态为空
    public static final String ERROR_MSG_ORDERCODE_OVERLENGTH = "积分商城订单编号超长！";//积分商城订单编号超长
    public static final String ERROR_MSG_ORDERSTATUS_OVERLENGTH = "积分商城订单状态超长！";//积分商城订单状态超长
    public static final String ORDERCODE_OVERLENGTH = "积分商城订单状态错误！";//积分商城订单状态错误
    public static final String ERROR_MSG_ORDERCODE_NOT_EXIST = "订单编号不存在！";//积分商城订单状态错误
    
    public static final String ERROR_MSG_ORDERID_NULL = "积分商城订单ID为空！";//积分商城订单编号为空
    public static final String ERROR_MSG_ORDERID_OVERLENGTH = "积分商城订单ID超长！";//积分商城订单编号超长
    public static final String ERROR_MSG_ORDERID_NOT_EXIST = "订单ID不存在！";//积分商城订单状态错误
    public static final String EXCHANGE_SUCCESS = "兑换成功";//兑换成功
    public static final String EXCHANGE_FAILED = "兑换失败";//兑换失败
    //积分商城配置项key值
    public static final String REIMBURSE_PERSON = "REIMBURSE_PERSON";//报账人姓名
    public static final String PASSWORD = "PASSWORD";//密码
    public static final String RATE = "RATE";//积分与金额转换比例=积分（分）/金额（元）
    public static final String APPLY_MOBILE = "APPLY_MOBILE";//申购人手机
    public static final String APPLY_PEOPLE_ID = "APPLY_PEOPLE_ID";//申购人ID
    public static final String APPLY_PEOPLE = "APPLY_PEOPLE";//申购人姓名
    public static final String DATA_AREA = "DATA_AREA";//数据区域
    public static final String REIMBURSE_PERSON_ID = "REIMBURSE_PERSON_ID";//报账人ID
    public static final String REIMBURSE_MOBILE = "REIMBURSE_MOBILE";//报账人手机
    public static final String BUSINESS_ACTIVITY_ID = "BUSINESS_ACTIVITY_ID";//业务活动ID
    public static final String EXPENSE_PROJECT_ID = "EXPENSE_PROJECT_ID";//费用项目ID
    public static final String BUDGET_SUBJECT_ID = "BUDGET_SUBJECT_ID";//预算科目ID
    public static final String USERNAME = "USERNAME";//用户名
    public static final String BASE_URL = "BASE_URL";//接口调用基础地址url
    public static final String POOL_NUM = "POOL_NUM";//商品池编号
    public static final String INVOICE_TYPE = "INVOICE_TYPE";//发票类型(2=增值税普通，3=增值税专用)
    public static final String INVOICE_TITLE = "INVOICE_TITLE";//发票抬头
    public static final String DELIVERY_TYPE = "DELIVERY_TYPE";//配送方式（1=快递，2=EMS，3=平邮，4=商户自有物流）
    public static final String COMPANY_NAME = "COMPANY_NAME";//单位名称
    public static final String INVOICE_CONTENT = "INVOICE_CONTENT";//发票内容。如果是增值税发票，发票内容为空，必须有发票明细；普通发票发票内容可以为办公用品、食品等
}

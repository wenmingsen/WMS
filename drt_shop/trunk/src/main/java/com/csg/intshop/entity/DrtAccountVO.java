...
public class DrtAccountVO{
	...
	/** 积分收益更新时间 */
	private java.sql.Timestamp earningsUpTime;

	/** 支付密码 */
	private String payPwd;

	/** 电融通用户编号 */
	private Integer drtyhbh;

	/** 输入支付密码错误次数 */
	private Integer paypwdFailCnt;

	/** 输入支付密码错误时间 */
	private java.sql.Timestamp paypwdFailTime;
	...
	/** 下次截止日期到期积分 */
	private Integer expiryEarnings;
	...
	/**
	 * 积分收益更新时间
	 * @param earningsUpTime 设置 earningsUpTime 属性值为参数值 earningsUpTime
	 */
	public void setEarningsUpTime(java.sql.Timestamp earningsUpTime) {
		this.earningsUpTime = earningsUpTime;
	}
	/**
	 * 积分收益更新时间
     * @return 获取earningsUpTime属性值
     */
	public java.sql.Timestamp getEarningsUpTime() {
		return this.earningsUpTime;	
	}
	...
	/**
	 * 电融通用户编号
	 * @param drtyhbh 设置 drtyhbh 属性值为参数值 drtyhbh
	 */
	public void setDrtyhbh(Integer drtyhbh) {
		this.drtyhbh = drtyhbh;
	}
	/**
	 * 电融通用户编号
     * @return 获取drtyhbh属性值
     */
	public Integer getDrtyhbh() {
		return this.drtyhbh;	
	}
	
	/**
	 * 输入支付密码错误次数
	 * @param paypwdFailCnt 设置 paypwdFailCnt 属性值为参数值 paypwdFailCnt
	 */
	public void setPaypwdFailCnt(Integer paypwdFailCnt) {
		this.paypwdFailCnt = paypwdFailCnt;
	}
	/**
	 * 输入支付密码错误次数
     * @return 获取paypwdFailCnt属性值
     */
	public Integer getPaypwdFailCnt() {
		return this.paypwdFailCnt;	
	}
	
	/**
	 * 输入支付密码错误时间
	 * @param paypwdFailTime 设置 paypwdFailTime 属性值为参数值 paypwdFailTime
	 */
	public void setPaypwdFailTime(java.sql.Timestamp paypwdFailTime) {
		this.paypwdFailTime = paypwdFailTime;
	}
	/**
	 * 输入支付密码错误时间
     * @return 获取paypwdFailTime属性值
     */
	public java.sql.Timestamp getPaypwdFailTime() {
		return this.paypwdFailTime;	
	}
	
	/**
	 * 用户登录app的设备id
	 * @param deviceid 设置 deviceid 属性值为参数值 deviceid
	 */
	...
	/**
	 * 推荐人
	 * @param referral 设置 referral 属性值为参数值 referral
	 */
	...
	/**
	 * 下次截止日期到期积分
	 * @param expiryEarnings 设置 expiryEarnings 属性值为参数值 expiryEarnings
	 */
	public void setExpiryEarnings(Integer expiryEarnings) {
		this.expiryEarnings = expiryEarnings;
	}
	/**
	 * 下次截止日期到期积分
     * @return 获取expiryEarnings属性值
     */
	public Integer getExpiryEarnings() {
		return this.expiryEarnings;	
	}
}

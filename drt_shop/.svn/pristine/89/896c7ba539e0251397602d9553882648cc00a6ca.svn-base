...
public class DrtAdministrativeRegionService{
	 ...
	 * @throws Exception 出错抛出异常
	 */
	public List<DrtAdministrativeRegion> selectList(DrtAdministrativeRegion drtAdministrativeRegion) throws Exception{
		return drtAdministrativeRegionMapper.selectList(drtAdministrativeRegion);
	}

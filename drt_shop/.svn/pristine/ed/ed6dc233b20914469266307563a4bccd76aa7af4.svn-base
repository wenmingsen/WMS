...
public interface EarningsCore {
	 ...
	 * 测试调用elec是否成功
	 */
	@RequestMapping(value = "${elec.ctx}/elec/api/testShopElec")
	public String testShopElec();
	...
	public Map<String, Object> updateEarningsFromExchange(@RequestParam(value="orderId") String orderId);
}

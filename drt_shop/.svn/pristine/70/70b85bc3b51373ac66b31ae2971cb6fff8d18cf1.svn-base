...
public class DrtShopOrderDetailController{
	...
	@ResponseBody
	public Map<String,Object> insertOrder(String id,String itemNum,String orderNum,String name,String phone,String address,HttpServletRequest request){
		...
		Map<String,Object> objMap = drtShopOrderDetailService.insertOrder(id,itemNum1, orderNum, name, phone, address, accountId);
		return objMap;

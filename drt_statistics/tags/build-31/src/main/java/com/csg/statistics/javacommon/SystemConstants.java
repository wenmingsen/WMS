...
public class SystemConstants {
    ...
    // 获取积分的类型：0表示消费产生的积分，1表示推广产生的积分
    public static final String EARNINGS_TYPE_CONSUME = "0";// 0表示消费产生的积分
    
    public static final String EARNINGS_TYPE_SPREAD = "1";// 1表示推广产生的积分
}

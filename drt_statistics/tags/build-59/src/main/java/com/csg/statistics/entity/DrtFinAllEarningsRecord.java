...
public class DrtFinAllEarningsRecord{
	...
	public String toString() {
		return "DrtFinAllEarningsRecord [poEarningsRecordId="
				+ poEarningsRecordId + ", poAccountId=" + poAccountId
				+ ", accountId=" + accountId + ", elecUserId=" + elecUserId
				+ ", earnings=" + earnings + ", totalEarnings=" + totalEarnings
				+ ", recordTime=" + recordTime + ", pmType=" + pmType
				+ ", fromType=" + fromType + ", fromName=" + fromName
				+ ", orderNo=" + orderNo + ", auditState=" + auditState
				+ ", currentEarnings=" + currentEarnings + ", lastModifyTime="
				+ lastModifyTime + "]";
	}

...
public class DrtMonitorLoginRecordService{
	 ...
	 * @return 影响条数
	 */
	public int insertMonitorLoginRecords(List<DrtMonitorLoginRecord> lstDrtMonitorLoginRecord){
		return drtMonitorLoginRecordMapper.insertMonitorLoginRecords(lstDrtMonitorLoginRecord);
	}
}
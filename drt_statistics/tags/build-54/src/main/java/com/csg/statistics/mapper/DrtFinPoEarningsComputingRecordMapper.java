...
public interface DrtFinPoEarningsComputingRecordMapper{
	 ...
	 * @return 预购账户积分收益计算明细表 记录集
	 */
	List<DrtFinPoEarningsComputingRecord> selectListByDrtFinPoEarningsComputingRecordQuery(DrtFinPoEarningsComputingRecordQuery drtFinPoEarningsComputingRecordQuery);

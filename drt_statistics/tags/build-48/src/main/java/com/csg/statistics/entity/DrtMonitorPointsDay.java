...
public class DrtMonitorPointsDay {
    ...
    /** 用户总人数 */
    private Integer presentAccountNum;
     ...
     * 当前时间总人数
     * 
     * @param presentAccountNum 设置当前时间总人数
     */
    
    public void setPresentAccountNum(Integer presentAccountNum) {
        this.presentAccountNum = presentAccountNum;
    }
    ...
    public Integer getPresentAccountNum() {
        return presentAccountNum;
    }

package com.csg.statistics.common.config;
...
public class CommonContants {
 ...
 // 接口txcode
	...
	public static final long redisSessionTimeOut = 600;//redis超时时间秒做单位
	
	/**奖励送积分类型**/
	public static final Integer earningType =4; //4为首次绑定送积分
}

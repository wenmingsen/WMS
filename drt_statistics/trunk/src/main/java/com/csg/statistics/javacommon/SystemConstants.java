...
public class SystemConstants {
    ...
    public static final String FINANCE_TYPE_HK = "00"; // 资产代办类型 划扣
    ...
    //处理汇总抵扣存入redis状态
    /**汇总抵扣处理中**/
    public static final String HZDK_STATE_DOING ="00";//汇总抵扣处理中
    /**汇总抵扣成功**/
    public static final String HZDK_STATE_SUCCESS ="01";//汇总抵扣成功
    /**汇总抵扣失败**/
    public static final String HZDK_STATE_FAIL ="02";//汇总抵扣失败
    /**汇总抵扣redis的key**/
    public static final String HZDK_KEY ="hzdkResult:";//汇总抵扣redis的key
    

    /**查询欠费失败记录状态**/
    /**查询欠费失败记录状态：0.未处理**/
    public static final String FAIL_RECORD_UNDEAL ="0";
    /**查询欠费失败记录状态：1.已处理**/
    public static final String FAIL_RECORD_DEAL ="1";
    /**处理查询欠费失败记录最多次数，默认为3**/
    public static final Integer FAIL_RECORD_SEARCH_COUNT =3;
}
